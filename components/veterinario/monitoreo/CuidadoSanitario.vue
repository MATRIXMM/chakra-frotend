  ...
  <div style="padding: 20px">
    <v-row style="display: flex; margin: 0 0 5px;align-items: center">
      <v-col md="10" style="padding: 0">
        <h2>
          Monitoreo de actividades de cuidado sanitario de {{this.animal.name}} con incidentes
        </h2>
      </v-col>
...
export default {
  ...
  methods: {
    changeFamily() {
      ...
      if (this.familiaSeleccionada.nombreFamilia === 'Pedro'){
      ...
      if (this.familiaSeleccionada.nombreFamilia === 'Perico'){
        this.registroCuidadoSanitario = [
          {
            nombreFamilia: 'Familia 1',
            nombreAnimal: 'Perico',
